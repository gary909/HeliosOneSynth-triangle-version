      ...
      |_______/  \____  $$|__/  |__/   \___/  |__/  |__/ \_______/|_______/ |__/|________/ \_______/|__/      
                ...
                |  $$$$$$/                                                                                    
                 \______/     
                                                                                 ...
                                                                                 v4.6 Tri Wave Version

   
 // A BlogHoskins Monstrosity @ 2019 / 2020
// https://bloghoskins.blogspot.com/
/*    
 *    v4.6 Triangle Wave Version 
 *    This version swaps the Saw wav for a Triangle wav
 *     
 *    v4.6 
...
//#include <tables/saw2048_int8.h> // saw table for oscillator **MUTED THIS SO WE CAN USE TRI WAVE**
#include <tables/square_no_alias_2048_int8.h> // square table for oscillator
#include <tables/triangle2048_int8.h> // triangle table for oscillator              **NEW**
...
//Oscil <SAW2048_NUM_CELLS, AUDIO_RATE> oscil1; //Saw Wav **MUTED THIS SO WE CAN USE TRI WAVE**
Oscil <SQUARE_NO_ALIAS_2048_NUM_CELLS, AUDIO_RATE> oscil2; //Sqr wave
Oscil <TRIANGLE2048_NUM_CELLS, AUDIO_RATE> oscil1; //Triangle Wav         ****NEW****
...
//*****************************ADD LFO**********************************************************************************
  ...
  {
    //oscil1.setTable(SAW2048_DATA); // muted this
    oscil1.setTable(TRIANGLE2048_DATA); // sets Triangle wave   ***NEW***
  }
  else  // If switch not set to high, run this portion of code instead
  {
